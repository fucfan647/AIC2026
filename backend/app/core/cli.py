...
class CliParser:
    ...
    def create_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument("--siglip2-embeddings", type=Path, default=Path("siglip2_embeddings/embeddings.npy"))
        parser.add_argument("--siglip2-model-name", default="google/siglip2-base-patch16-224")
        ...
        parser.add_argument("--siglip2-milvus-collection", default="synthetic_siglip2_backend_store_v1")
