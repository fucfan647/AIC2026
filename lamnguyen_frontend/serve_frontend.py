...
DEFAULT_DELETED_MANIFEST = (
    FRONTEND_DIR.parent / "backend/artifacts/current_index/active_deleted_manifest.jsonl"
    if (FRONTEND_DIR.parent / "backend/artifacts/current_index/active_deleted_manifest.jsonl").is_file()
    else FRONTEND_DIR.parent / "frames_deleted/active_deleted_manifest.jsonl"
)
...
def create_app(
    ...
    LOCAL_KEYFRAME_ROOTS = [
        Path(r"D:\Folder\AICHALLENGE2026\keyframes_AIC_2026\synthetic_frames\synthetic_frames"),
        Path(r"D:\Folder\AICHALLENGE2026\keyframes_AIC_2026\synthetic_frames"),
        Path(r"D:\Folder\AICHALLENGE2026\keyframes_AIC_2026"),
        FRONTEND_DIR.parent.parent / "keyframes_AIC_2026" / "synthetic_frames" / "synthetic_frames",
        FRONTEND_DIR.parent.parent / "keyframes_AIC_2026" / "synthetic_frames",
        FRONTEND_DIR.parent.parent / "keyframes_AIC_2026",
